...
public class RondaTest {
    ...
    void crearRondaSeteaLosValoresInicialesCorrectamente(){
        ...
        assertEquals( "alma", ronda.getPalabraAAdivinar());
    ...
    void adivinarLaPalabraCompletaSuma7Puntos(){
        int puntaje = ronda.evaluarLetra('a',jugador);
        puntaje += ronda.evaluarLetra('l',jugador);
    ...
    void seGuardanLasLetrasUsadasYEquivocadas(){
        ...
        ronda.evaluarLetra('a',jugador);
//        List<Character> letrasUsadas = List.of('h', 'k', 'r', 't', 'a');
//        List<Character> letrasEquivocadas = List.of('h', 'k', 'r', 't');

        String letrasUsadas = "hkrta";
        String letrasEquivocadas = "hkrt";
    ...
    void noAdivinaLaPalabraYResta10Puntos(){
        ...
        puntaje += ronda.evaluarLetra('t',jugador);
